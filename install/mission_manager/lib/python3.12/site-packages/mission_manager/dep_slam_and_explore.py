...
Usage:
    ...
    When "Saved end pose" appears in terminal, Ctrl+C to kill this node,
...
class SlamAndExplore(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('map_file', os.path.expanduser('~/code/robot_sim_nav/src/maps'))
    ...
    def _record_and_save_end_pose(self):
        ...
        self.get_logger().info(
            ...
            'You can now Ctrl+C this node and run amcl_and_nav. ***'
        )
